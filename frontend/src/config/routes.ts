...
const pages = {
  ...
  EventList: () => import('../pages/EventListPage'),
  EventRules: () => import('../pages/EventRulesPage'),
  SilenceRules: () => import('../pages/SilenceRulesPage'),
  Resources: () => import('../pages/ResourcesPage'),
  ResourceList: () => import('../pages/ResourceListPage'),
  ResourceGroups: () => import('../pages/ResourceGroupsPage'),
  TopologyView: () => import('../pages/TopologyViewPage'),
  Infrastructure: () => import('../pages/SREInfrastructureInsightPage'),
  Dashboard: () => import('../pages/DashboardPage'),
  DashboardList: () => import('../pages/DashboardListPage'),
  DashboardView: () => import('../pages/DashboardViewPage'),
  Analyzing: () => import('../pages/AnalyzingPage'),
  CapacityPlanning: () => import('../pages/CapacityPlanningPage'),
...
export const routes: RouteConfig[] = [
  ...
  { path: '/incidents/list', component: pages.EventList(), title: '事件列表' },
  { path: '/incidents/rules', component: pages.EventRules(), title: '事件規則' },
  { path: '/incidents/silence', component: pages.SilenceRules(), title: '靜音規則' },
  { path: '/resources', component: pages.Resources(), title: '資源管理' },
  { path: '/resources/list', component: pages.ResourceList(), title: '資源列表' },
  { path: '/resources/groups', component: pages.ResourceGroups(), title: '資源群組' },
  { path: '/resources/topology', component: pages.TopologyView(), title: '拓撲視圖' },
  { path: '/infrastructure', component: pages.Infrastructure(), title: '基礎設施洞察' },
  { path: '/dashboard', component: pages.Dashboard(), title: '儀表板管理' },
  { path: '/dashboard/list', component: pages.DashboardList(), title: '儀表板列表' },
  ...
  { path: '/analyzing/capacity', component: pages.CapacityPlanning(), title: '容量規劃' },
